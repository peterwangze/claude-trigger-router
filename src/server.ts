...
export const createServer = (config: any): Server => {
  ...
  server.app.get("/ui", async (_: any, reply: any) => {
    ...
    return reply.send(
      ...
      `  triggerAnalysisScope.value=smart.analysis_scope || trigger.analysis_scope || 'last_message';` +
