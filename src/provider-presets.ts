...
const PROVIDER_PRESETS: Record<ProviderPresetKey, IProviderPresetDefinition> = {
  ...
  anthropic: {
    ...
    model_examples: ['claude-sonnet-4-6', 'claude-opus-4-5', 'claude-haiku-4-5'],
    suggested_id: 'claude',
  ...
  openrouter: {
    ...
    model_examples: ['openrouter/auto', 'anthropic/claude-sonnet-4.5', 'deepseek/deepseek-v4-flash'],
