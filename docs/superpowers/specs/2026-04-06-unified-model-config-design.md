...
> **统一进展承接说明（2026-04-16）**
>
> 本文档承接 `docs/superpowers/plans/unified-progress-baseline.md` 中“配置产品化最终收口”与“OpenAI-compatible 兼容差异内化”两行的核心设计输入。
>
> 当前职责：承接统一模型配置、message IR 与协议转换的详细设计；顶层入口只保留该特性的状态、闭环结论与文档指针。
